...
const char* getReturnMessage(ReturnValue value)
{
	switch (value) {
		...
		case RETURNVALUE_NOTREQUIREDLEVELTOUSERUNE:
			return "You do not have the required nin jutsu to use this rune.";
		...
		case RETURNVALUE_NOTENOUGHMAGICLEVEL:
			return "You do not have enough nin jutsu.";

		case RETURNVALUE_NOTENOUGHMANA:
			return "You do not have enough chakra.";
		...
		case RETURNVALUE_YOUNEEDTOLEARNTHISSPELL:
			return "You must learn this jutsu first.";
		...
		case RETURNVALUE_YOUNEEDAWEAPONTOUSETHISSPELL:
			return "You need to equip a weapon to use this jutsu.";
		...
		case RETURNVALUE_CANONLYUSEONESHIELD:
			return "You may use only one defense weapon.";
